...
export default function Navigation() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-64 fixed inset-y-0 bg-slate-900 border-r border-slate-800 p-4">
        <div className="text-2xl font-bold tracking-tighter mb-8 text-white px-2">FinTrack.</div>
