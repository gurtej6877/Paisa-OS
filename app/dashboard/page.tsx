...
import { Activity, ArrowUpRight, ArrowDownRight, Wallet, Target } from 'lucide-react'

// Note: Recharts components would typically be extracted into a separate 'use client' file.
// Simulated Server-Side computation logic to keep the Dashboard fast.
...
export default async function Dashboard() {
  ...
  const currentMonthTotal = expenses?.reduce((sum, exp) => sum + Number(exp.amount), 0) || 0
  const daysInMonthSoFar = date.getDate()
